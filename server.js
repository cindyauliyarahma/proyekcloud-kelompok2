                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="text-sm divide-y divide-slate-100">
                            <tr><td class="py-4 px-4 font-medium text-slate-900">Cindy Auliya Rahma(220121055)</td><td class="py-4 px-4 text-slate-600">Cloud Architecture & CI/CD Setup</td></tr>
